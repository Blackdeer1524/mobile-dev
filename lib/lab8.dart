...
class _HandLabState extends State<HandLab> {
  ...
  // Check if hand is near sphere (within 3 units distance)
  bool _isNearSphere() {
  ...
  void _updateHandPosition(double deltaX, double deltaY) {
    setState(() {
      ...
      // If grabbing and near sphere, move sphere with hand
        ...
        child: Flex(
          ...
          children: [
            FutureBuilder(
              future: sceneObjs,
              builder:
                  (BuildContext context, AsyncSnapshot<List<Mesh3D>> snapshot) {
                            ...
                            child: DiTreDi(
                              figures: [
                                TransformModifier3D(
                                  snapshot.data![0],
                                  Matrix4.identity()
                                    ..translate(handXAxisDisplacement, handYAxisDisplacement, 0)
                                    ..rotateX(-pi / 2),
                                ),
                                TransformModifier3D(
                                  snapshot.data![1],
                                ...
                                TransformModifier3D(
                                  snapshot.data![5],
                                  Matrix4.identity()
                                  ..translate(sphereXAxisDisplacement, sphereYAxisDisplacement, -2)
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                                ...
                                child: CupertinoButton(
                                  ...
                                  onPressed: () {
                                    setState(() {
                                      ...
                                      if (fingerAngle == 0) {
                                        isGraspingSphere = false;
                                      } else if (fingerAngle == 12 && _isNearSphere()) {
                                        isGraspingSphere = true;
                                      }
                                    });
                                  },
                              ...
                              const Text("Hand Position", style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
                              Row(
                                ...
                                children: [
                                  Column(
                                    children: [
                                      ...
                                      Text("X: ${handXAxisDisplacement.toStringAsFixed(1)}"),
                                      CupertinoButton(
                                        color: CupertinoColors.activeBlue,
                                        onPressed: () {
                                          _updateHandPosition(-0.5, 0.0);
                                  ...
                                  Column(
                                    children: [
                                      ...
                                      Text("Y: ${handYAxisDisplacement.toStringAsFixed(1)}"),
                                      CupertinoButton(
                                        color: CupertinoColors.activeBlue,
                                        onPressed: () {
                                          _updateHandPosition(0.0, -0.5);
                              ...
                              // const Text("Sphere Position", style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
                              // Row(
                              //   mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                              //   children: [
                              //     Column(
                              ...
                              //           onPressed: () {
                              //             setState(() {
                              //               sphereXAxisDisplacement += 0.5;
                              //             });
                              //           },
                              //           child: const Text('→'),
                              //         ),
                              //         Text("X: ${sphereXAxisDisplacement.toStringAsFixed(1)}"),
                              //         CupertinoButton(
                              //           color: CupertinoColors.systemPurple,
                              //           onPressed: () {
                              //             setState(() {
                              ...
                              //           onPressed: () {
                              //             setState(() {
                              //               sphereYAxisDisplacement += 0.5;
                              //             });
                              //           },
                              //           child: const Text('↑'),
                              //         ),
                              //         Text("Y: ${sphereYAxisDisplacement.toStringAsFixed(1)}"),
                              //         CupertinoButton(
                              //           color: CupertinoColors.systemPurple,
                              //           onPressed: () {
                              //             setState(() {
